	...
	export const drops = [
		{
			...
			copy: [
                ...
                ["readMore", "Read our full <a style='color: inherit' href='https://twitter.com/TheChimpions/status/1552347499377065990?s=20&t=FQ_D4JF10bTHVwFYWy5-Sg' target='_blank'>artist interview here</a>"],
                ...
                ["readMore", "Read our <a style='color: inherit' href='' target='_blank'>project analysis here</a>"]
			],
			qa: [
		...
		},
		{
			...
			copy: [
				...
				["readMore","Read our full <a style='color: inherit' href='https://twitter.com/TheChimpions/status/1563212852474761216?s=20&t=_su4m4PfmlfOX_pLuACQpA' target='_blank' class='text-gray-100 underline'>artist interview here</a>"],
				...
				["readMore","Check out their <a style='color: inherit' href='https://docs.google.com/document/d/1ojrTcNDDWhcAuylcuf2m6nK8J6TeRljijZcPJoFWRg4/edit?usp=sharing' target='_blank'>Vision Document</a> for a broader overview of who they are and what they are building."],
			],
		},
		{
			artist: 'RGB',
			...
			copy: [
				...
				["readMore", "Read our full <a style='color: inherit' href='https://twitter.com/TheChimpions/status/1567960875012878337?s=20&t=Mimimr4gTRTqcyctKItv6w' target='_blank'>artist interview here</a>"],
				...
				["readMore", "Check out the <a style='color: inherit' href='https://critterscult.com/' target='_blank'>Evocative Sci-Fi Mystery here</a>, and make sure to unmute!"],
			],
			qa: [
		...
		},
		{
			...
			copy: [
				...
				["readMore", "Read our full <a style='color: inherit' href='https://twitter.com/TheChimpions/status/1575610198093312005?s=20&t=oXvSs0QcW22nZ9DajgDtSQ' target='_blank'>artist highlight here</a>!"],
				...
				["readMore", "Check out the <a style='color: inherit' href='https://psychopompcomics.com/' target='_blank'>Seed of Cain here</a>!"],
			],
		},
		{
			artist: 'UGS Labs',
			...
			copy: [
				...
				["readMore", "Read more about Core <a style='color: inherit' href='https://twitter.com/TheChimpions/status/1581703796237168640?s=20&t=pO87p4HR4ahLW93gU-YHdA' target='_blank'>here</a>!"]
			]
		},
		{
			...
			copy: [
				...
				["readMore", "Checkout the Masked Warriors <a style='color: inherit' href='https://www.maskedwarriors.xyz/' target='_blank'>here</a>!"],
		...
		},
		{
			...
			copy: [
				...
				["readMore", "Read more about Knittables <a style='color:inherit' href='https://www.knittables.io/' target='_blank'>here!</a>"]
			]
		},
		{
            artist: 'Art by Nafay',
