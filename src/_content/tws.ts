...
export const drops: Drop[] = [
	...
	},
	{
		...
		copy: [
			...
			"Yume Labs is the brainchild of Misty Bayou and NYaUmon: a multi-project umbrella organization dedicated to realizing the potential of Solana NFTs and the decentralized economy that they open up.  Check out their <a href='https://docs.google.com/document/d/1ojrTcNDDWhcAuylcuf2m6nK8J6TeRljijZcPJoFWRg4/edit?usp=sharing' target='_blank'>Vision Document</a> for a broader overview of who they are and what they are building.",
		],
	},
	{
		artist: 'unrevealed',
