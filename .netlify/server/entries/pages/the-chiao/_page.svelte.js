...
const Structure = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section><h2 class="subsectionHeading svelte-1kcnp7d" data-svelte-h="svelte-5psi5j">Structure</h2> <div class="subsectionParagraph" data-svelte-h="svelte-c61i5a"><p>The Chimpions have adapted to the ecosystem in which they live. Whereas a model where 10 Leads representing the Chimpions served them for just over a year, the Chimpions have decided to pivot to a governance model with a CEO.</p> <p>The new model operates as follows:
