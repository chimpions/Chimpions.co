...
const css$1 = {
  code: ':root{--s:1;--z:1;--rx:0deg;--ry:0deg;--bd-color:#ffffff}.card.svelte-1k8rv78.svelte-1k8rv78{height:394px;width:302px;margin-bottom:2vh;--radius:0.75rem;border-radius:var(--radius);z-index:var(--z);transform:translate3d(0, 0, 0.1px);-webkit-transform:translate3d(0, 0, 0.1px);will-change:transform, visibility;transform-style:preserve-3d;-webkit-transform-style:preserve-3d}.dynamic__card.svelte-1k8rv78.svelte-1k8rv78{height:394px;width:302px}.card.active.svelte-1k8rv78 .card__translater.svelte-1k8rv78,.card.active.svelte-1k8rv78 .card__rotator.svelte-1k8rv78{touch-action:none}.card__translater.svelte-1k8rv78.svelte-1k8rv78,.card__rotator.svelte-1k8rv78.svelte-1k8rv78{display:grid;perspective:600px;transform-origin:center;-webkit-transform-origin:center;will-change:transform}.card__translater.svelte-1k8rv78.svelte-1k8rv78{width:auto;position:relative;transform:scale(var(--s));-webkit-transform:scale(var(--s));image-rendering:pixelated;display:flex;flex-direction:row;flex-flow:row nowrap}.card__rotator.svelte-1k8rv78.svelte-1k8rv78{transform:rotateY(var(--rx)) rotateX(var(--ry));transform-style:preserve-3d;-webkit-transform:rotateY(var(--rx)) rotateX(var(--ry));-webkit-transform-style:preserve-3d;box-shadow:0px 10px 20px -5px black;border-radius:var(--radius);outline:none;transition:box-shadow 0.4s ease, outline 0.2s ease}button.card__rotator.svelte-1k8rv78.svelte-1k8rv78{appearance:none;-webkit-appearance:none;border:none;background:top;padding:0;box-shadow:0px 0px 20px var(--bd-color)}.card__rotator.svelte-1k8rv78 *{width:100%;display:grid;grid-area:1/1;transform-style:preserve-3d;-webkit-transform-style:preserve-3d}.card__back.svelte-1k8rv78.svelte-1k8rv78{border-radius:var(--radius);transform:rotateY(180deg) translateZ(1px);-webkit-transform:rotateY(180deg) translateZ(1px);backface-visibility:hidden}.rotate.svelte-1k8rv78 .card__back.svelte-1k8rv78{transform:rotateY(0deg) translateZ(1px);-webkit-transform:rotateY(0deg) translateZ(1px);backface-visibility:hidden}.card__front.svelte-1k8rv78.svelte-1k8rv78,.card__front.svelte-1k8rv78 .svelte-1k8rv78{backface-visibility:hidden}.card__front.svelte-1k8rv78.svelte-1k8rv78{border-radius:var(--radius);display:flex;flex-direction:column;justify-content:center;align-items:center;background:no-repeat url("/images/chimp-front-card-v2.png");background-size:cover;opacity:1;text-shadow:1px 2px 5px black}.card__back.svelte-1k8rv78.svelte-1k8rv78{background:no-repeat url("/images/chimp-back-card-v2.png");background-size:cover;display:flex;flex-direction:column;justify-content:center;align-items:center;color:white;text-align:center;height:100%;width:100%}.loading.svelte-1k8rv78 .card__front.svelte-1k8rv78{opacity:0}.loading.svelte-1k8rv78 .card__back.svelte-1k8rv78{transform:rotateY(0deg);-webkit-transform:rotateY(0deg)}.chimpion__name.svelte-1k8rv78.svelte-1k8rv78{position:absolute;top:19px;left:25px;text-align:left;font-style:italic;font-size:1.5rem;color:white;text-shadow:1px 2px 5px black;opacity:1}.level_box.svelte-1k8rv78.svelte-1k8rv78{display:flex;justify-content:end;align-items:baseline;position:absolute;top:25px;right:26px;text-align:right;color:white;font-size:0.75rem}.level.svelte-1k8rv78.svelte-1k8rv78{width:fit-content;margin-left:2px;font-size:1rem}.description__card.svelte-1k8rv78.svelte-1k8rv78{position:absolute;top:288px;text-align:left;width:240px;padding:8px;color:white;font-style:italic;line-height:1.25rem;font-size:1rem;display:flex;flex-direction:column}.description__card.svelte-1k8rv78 .holder.svelte-1k8rv78{display:flex}.card.svelte-1k8rv78 a.svelte-1k8rv78{color:inherit;width:fit-content}.lore.svelte-1k8rv78.svelte-1k8rv78{position:absolute;width:100%;padding:2rem;font-size:1rem;font-style:italic;line-height:1.25rem}.card__rotator.svelte-1k8rv78 .image-container.svelte-1k8rv78{position:absolute;top:50px;height:238px;width:284px;display:flex}.card__rotator.svelte-1k8rv78 .image.svelte-1k8rv78{height:238px;width:238px;align-items:center}.control-dots.svelte-1k8rv78.svelte-1k8rv78{width:100%;margin:0px;padding:0;position:absolute;bottom:0;display:flex;justify-content:center}.dot.svelte-1k8rv78.svelte-1k8rv78{opacity:.3;width:8px;height:8px;background:#fff;border-radius:50%;margin:5px;transition:opacity .2s ease;display:inline-block;box-shadow:1px 1px 2px rgba(0,0,0,.9)}.dot.selected.svelte-1k8rv78.svelte-1k8rv78{opacity:1}.control-arrow-prev.svelte-1k8rv78.svelte-1k8rv78{padding:5px;background:0 0;color:#fff;opacity:.4;text-align:left;cursor:pointer;width:22px;align-items:center;justify-content:center;border:0;transition:all .3s ease}.control-arrow-next.svelte-1k8rv78.svelte-1k8rv78{padding:5px;background:0 0;color:#fff;opacity:.4;text-align:right;cursor:pointer;width:22px;align-items:center;justify-content:center;border:0;transition:all .3s ease}.control-arrow-prev.svelte-1k8rv78.svelte-1k8rv78:hover{opacity:1}.control-arrow-next.svelte-1k8rv78.svelte-1k8rv78:hover{opacity:1}.control-arrow-prev.svelte-1k8rv78.svelte-1k8rv78:before{content:"";border-top:10px solid transparent;border-right:10px solid #fff;border-bottom:10px solid transparent;margin:0 5px;display:inline-block}.control-arrow-next.svelte-1k8rv78.svelte-1k8rv78:before{content:"";border-top:10px solid transparent;border-left:10px solid #fff;border-bottom:10px solid transparent;margin:0 5px;display:inline-block}',
  map: null
};
const Card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    "card svelte-1k8rv78",
    "  loading"
  ].join(" ").trim()}"${add_attribute("style", styles, 0)}${add_attribute("this", thisCard, 0)}><div class="card__translater svelte-1k8rv78"><button class="card__rotator svelte-1k8rv78"${add_attribute("id", index.toString(), 0)} aria-label="${"Expand the Card of " + escape(name, true) + "."}" tabindex="0"${add_attribute("this", rotator, 0)}><div class="dynamic__card svelte-1k8rv78"><div><div class="card__front svelte-1k8rv78"${add_attribute("style", getFrontCardBg, 0)}>${name.length > 21 ? `<div class="chimpion__name svelte-1k8rv78" style="font-size: 0.875rem; top:26px">${escape(name)}</div>` : `${name.length > 15 ? `<div class="chimpion__name svelte-1k8rv78" style="font-size:1.25rem; top:22px">${escape(name)}</div>` : `<div class="chimpion__name svelte-1k8rv78">${escape(name)}</div>`}`} <div class="level_box svelte-1k8rv78">lvl.<span class="level svelte-1k8rv78">${escape(level)}</span></div> <div class="image-container svelte-1k8rv78"><button type="button" tabindex="0" aria-label="previous slide / item" class="control-arrow-prev svelte-1k8rv78"${add_attribute("this", previous, 0)}></button> <div class="image svelte-1k8rv78">${displayed_image.slice(-3) == "mp4" || displayed_image.slice(-3) == "mov" ? ` <video autoplay width="400" style="image-rendering: auto" class="svelte-1k8rv78"${add_attribute("this", videoPlayer, 0)}><source${add_attribute("src", displayed_image, 0)} type="video/mp4" class="svelte-1k8rv78"></video>` : `${currentIndex <= 1 ? `<img${add_attribute("src", displayed_image, 0)} style="image-rendering: pixelated" loading="lazy" alt="${"Art " + escape(currentIndex + 1, true) + " of " + escape(name, true)}" class="svelte-1k8rv78">` : `<img${add_attribute("src", displayed_image, 0)} style="image-rendering: auto" loading="lazy" alt="${"Art " + escape(currentIndex + 1, true) + " of " + escape(name, true)}" class="svelte-1k8rv78">`}`} <ul class="control-dots svelte-1k8rv78">${each(images, (image, i) => {
    return `<li class="${escape(null_to_empty(i === currentIndex ? "dot selected" : "dot"), true) + " svelte-1k8rv78"}"${add_attribute("value", i, 0)} aria-label="${"slide item " + escape(i + 1, true)}"></li>`;
  })}</ul></div> <button type="button" tabindex="0" aria-label="next slide / item" class="control-arrow-next svelte-1k8rv78"${add_attribute("this", next, 0)}></button></div> <div class="description__card svelte-1k8rv78"><span class="svelte-1k8rv78">Tribe: ${escape(tribe.split(/(?=[A-Z])/).join(" "))}</span> <span class="svelte-1k8rv78">Type: ${escape(type)}</span> ${holder_name != "" ? `<span class="holder svelte-1k8rv78">Holder: <a href="${"https://twitter.com/" + escape(twitter, true)}" target="_blank" class="svelte-1k8rv78">${escape(holder_name)}</a></span>` : `<span class="svelte-1k8rv78" data-svelte-h="svelte-ikipug">Holder: Unknown</span>`} <span class="svelte-1k8rv78">Artist: ${escape(artist)}</span></div></div></div> <div class="card__back svelte-1k8rv78"><div class="lore svelte-1k8rv78">${lore != "" ? `<p><!-- HTML_TAG_START -->${loreToDisplay}<!-- HTML_TAG_END --></p>` : `No lore for this chimpion yet...`}</div></div></div></button></div> </div>`;
});
