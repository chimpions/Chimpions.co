...
const css$2 = {
  code: ":root{--bg-artist:var(--purple)}.artistBox.svelte-tgh7vp{background-color:var(--dark-purple);border-radius:0.25rem;margin-bottom:4vw;padding:1rem;border-width:4px;border-color:transparent}.artistBox.svelte-tgh7vp:hover{background-color:var(--purple);--bg-artist:var(--light-purple)}.artist.svelte-tgh7vp{text-align:center;border-radius:0.25rem;background-color:var(--bg-artist);font-size:2.25rem;line-height:2.5rem;padding:1rem}.artistBio.svelte-tgh7vp{display:grid;grid-template-columns:repeat(1, minmax(0, 1fr));margin-top:1.25rem;text-align:justify}.socialLinks.svelte-tgh7vp{font-size:1.25rem;line-height:1.75rem;margin-top:1.5rem;margin-bottom:0.5rem;color:#fff}.bioContainer.svelte-tgh7vp{display:flex;align-items:center;column-gap:0.5rem;margin-left:1rem;color:rgb(209 213 219);text-decoration-line:underline}.artLinks.svelte-tgh7vp{font-size:1.25rem;line-height:1.75rem;padding-top:0.5rem;margin-top:0.5rem;margin-bottom:0.5rem;color:#fff}a.svelte-tgh7vp{overflow:hidden;margin-bottom:0.25rem}a.svelte-tgh7vp:hover{color:rgb(255 255 255)}",
  map: null
};
const Treehouse_artists = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="artistBox svelte-tgh7vp"><div class="artist svelte-tgh7vp"><div><img style="border-radius: 0.25rem; width: 100%"${add_attribute("src", `images/artist/${piece}`, 0)} alt="Artist's piece"></div> <h2 style="font-size: 2.5rem; margin: 0.5rem 0 0 0">${escape(name)}</h2></div> <div class="artistBio svelte-tgh7vp">${escape(bio)}</div> <div><h2 class="socialLinks svelte-tgh7vp" data-svelte-h="svelte-1pbc20z">Social Links</h2> ${twitter ? `<a class="bioContainer svelte-tgh7vp"${add_attribute("href", twitter, 0)}>${validate_component(Fa, "Fa").$$render($$result, { icon: faTwitter, size: "sm" }, {}, {})}Twitter</a>` : ``} ${instagram ? `<a class="bioContainer svelte-tgh7vp"${add_attribute("href", instagram, 0)}>${validate_component(Fa, "Fa").$$render($$result, { icon: faInstagram, size: "sm" }, {}, {})}Instagram</a>` : ``} <h2 class="artLinks svelte-tgh7vp" data-svelte-h="svelte-j7cz27">Art Links</h2> ${portfolio ? `<a class="bioContainer svelte-tgh7vp"${add_attribute("href", portfolio, 0)}>${validate_component(Fa, "Fa").$$render($$result, { icon: faIdCard, size: "sm" }, {}, {})}Portfolio</a>` : ``} ${marmelade ? `<a class="bioContainer svelte-tgh7vp"${add_attribute("href", marmelade, 0)}>${validate_component(Fa, "Fa").$$render($$result, { icon: faLink, size: "sm" }, {}, {})}Marmelade</a>` : ``} ${exchangeart ? `<a class="bioContainer svelte-tgh7vp"${add_attribute("href", exchangeart, 0)}>${validate_component(Fa, "Fa").$$render($$result, { icon: faLink, size: "sm" }, {}, {})}Exchange Art</a>` : ``} ${misc ? `<a class="bioContainer svelte-tgh7vp"${add_attribute("href", misc, 0)}>${validate_component(Fa, "Fa").$$render($$result, { icon: faLink, size: "sm" }, {}, {})} ${misc.length > 30 ? `${escape(misc.slice(0, 30))}` : `${escape(misc)}`}</a>` : ``}</div> </div>`;
});
